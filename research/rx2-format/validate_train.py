#\!/usr/bin/env python3
"""
Generic RX2 validation script for train dataset
"""
...
def validate_train_dataset():
    """Validate algorithm performance on train dataset"""
    
    # Load metadata
    datasets_path = Path('./datasets')
    metadata_path = datasets_path / 'train' / 'metadata.json'
    ...
    for file_info in split_data['files']:
        ...
        filepath = datasets_path / 'train' / 'rx2' / filename
...
if __name__ == "__main__":
    success = validate_train_dataset()
