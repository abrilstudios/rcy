#\!/usr/bin/env python3
"""
Generic RX2 validation script for test dataset
"""
...
def validate_test_dataset():
    """Validate algorithm performance on test dataset"""
    
    # Load metadata
    datasets_path = Path('./datasets')
    metadata_path = datasets_path / 'test' / 'metadata.json'
    ...
    for file_info in split_data['files']:
        ...
        filepath = datasets_path / 'test' / 'rx2' / filename
